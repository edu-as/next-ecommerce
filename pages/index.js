  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Dockstage camisetaria</title>
          <meta
            name="description"
            content="Dockstage a plataforma ecommerce, feita para facilitar sua vida"
          />
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        <h2 className="text-4xl mb-3">Tendência agora</h2>
        <p className="text-gray-600 text-sm">
          Encontre a peça ou acessório perfeita para você.
        </p>
      </div>

...
const Checkout = ({ context }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!street || !city || !postal_code || !state) {
      setErrorMessage("Por favor preencha o formulário!")
      return
    }
  ...
  if (orderCompleted) {
    return (
      <div>
        <h3>Obrigado! Seu pedido foi processado com sucesso.</h3>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col items-center pb-10">
      <Head>
        <title>Dockstage - Checkout</title>
          ...
          <Link href="/cart">
            <a aria-label="Cart">
              <div className="cursor-pointer flex  items-center">
                ...
                <p className="text-gray-600 text-sm">Editar Carrinho</p>
              </div>
            </a>
          </Link>
        </div>
            ...
            <div className="flex flex-1 flex-col md:flex-row">
              ...
              <div className="md:pt-20">
                ...
                <div className="pl-4 flex flex-1 my-2">
                  <p className="text-sm pr-10">Envio</p>
                  <p className="w-38 flex justify-end">Envio grátis</p>
                </div>

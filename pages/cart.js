  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>Dockstage Camisetarias - Carrinho</title>
          <meta
            name="description"
            content={`Dockstage Camisetarias - Shopping cart`}
          />
          <meta
            property="og:title"
            content="Dockstage Camisetarias - Cart"
            key="title"
          />
        </Head>
        <div
        ...
        >
          <div className="pt-10 pb-8">
            <h1 className="text-5xl font-light">Seu carrinho</h1>
          </div>
